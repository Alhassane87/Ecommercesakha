...
<div class="text-white py-8 px-6 rounded-lg shadow-lg mb-6" style="background: var(--primary-gradient)">
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h1 class="text-3xl font-bold text-white mb-2">Ajouter un utilisateur</h1>
            <p class="text-white/90">Creer un nouveau compte admin ou client</p>
        </div>
    </div>
</div>
        ...
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-5">
            ...
            <div>
                ...
                <select
                    ...
                    required
                    class="w-full rounded-xl border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white focus:ring-indigo-500 focus:border-indigo-500">
                    <option value="customer" @selected(old('role', 'customer') === 'customer')>Client</option>
            ...
            <div class="flex items-center gap-3 pt-4">
                <button type="submit" class="px-5 py-3 rounded-xl text-white font-semibold shadow-lg" style="background: var(--action-success)">
